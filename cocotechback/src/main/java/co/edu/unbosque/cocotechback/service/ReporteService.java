...
public class ReporteService {
	...
	public int recalcularMes(Integer anio, Integer mes) {
		...
		for (Document agg : agregados) {
			String nombreSucursal = agg.getString("_id");
			...
			// idSucursal queda null si el reporte se construye solo desde
			// el nombre embebido. Para tener el ID, conviene incluir
			// sucursal.idSucursal en el $group del repositorio.
			Optional<ReporteVentasMensual> existente = reporteRepo
					.findByAnioAndMesAndIdSucursal(anio, mes, null);
