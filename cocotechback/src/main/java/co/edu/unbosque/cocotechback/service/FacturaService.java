 ...
 * <p>
 * También expone métodos para los reportes contables requeridos en los
 * objetivos del proyecto: ingreso bruto total e impuestos recaudados por
 * periodo.
 */
@Service
public class FacturaService implements CRUDOperation<FacturaDTO, Factura> {
	...
	/**
	 * Crea una nueva factura en la base de datos a partir de un
	 * {@link FacturaDTO}.
	 * <p>
	 * Valida que la venta exista y que aún no tenga una factura generada
	 * (restricción 1:1 del supuesto). La fecha se asigna al momento actual si
	 * no se proporciona.
	 *
	 ...
	 *
	 * @return Una lista de {@link FacturaDTO}. Retorna una lista vacía si no hay
	 *         facturas.
	 */
	@Override
	...
	/**
	 * Actualiza los datos de una factura existente por su ID.
	 *
	 ...
	 * @param inicio Fecha y hora de inicio del periodo.
	 * @param fin    Fecha y hora de fin del periodo.
	 * @return El total de impuestos recaudados, o {@code 0.0} si no hay facturas.
	 */
