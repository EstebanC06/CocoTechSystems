...
public class OpenApiConfig {
	...
	public OpenAPI customOpenAPI() {
		...
		String mainDescription = "<h2>Guía de uso de la API REST de CocoTech</h2>"
				...
				+ "<li><strong>ROLE_CLIENTE</strong>: Consulta productos, categorías y su historial "
				+ "de compras y facturas propias.</li>"
				+ "<li><strong>ROLE_ADMIN</strong>: Acceso total — gestión de inventario, empleados, "
				+ "proveedores, sucursales, ventas y reportes analíticos.</li></ul>"
